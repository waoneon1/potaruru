...
<body class="fixed-header">
  ...
  <section class="bg-primary">
    <div class="container">
      <h3 class="text-white font-weight-300 m-b-0">Popovers &amp; Tooltips</h3>
    </div>
  </section>
  ...
  <section class="breadcrumbs">
    <div class="container">
      <ol class="breadcrumb">
        ...
        <li class="active">Popovers &amp; Tooltips</li>
      </ol>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <h5>Example</h5>
      <p>When you have some styles on a parent element that interfere with a popover, you’ll want to specify a custom container so that the popover’s HTML appears within that element instead.</p>
          ...
          <div class="col-lg-3">
            <div class="popover bs-popover-top">
              ...
              <div class="popover-body">
                <p>Sometimes you want to add a popover to a hyperlink that wraps multiple lines. The default behavior of the popover plugin is to center it.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3">
      ...
      <div class="row m-t-70">
        ...
        <div class="col-lg-6">
          <h5>Positions</h5>
          <p>Popovers require the tooltip plugin to be included in your version of Bootstrap.</p>
          <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="left" data-content="Sometimes you want to add a popover to a hyperlink that wraps multiple lines. The default behavior of the popover plugin is to center it.">
          Popover on left
        </button>
          <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="top" data-content="Sometimes you want to add a popover to a hyperlink that wraps multiple lines. The default behavior of the popover plugin is to center it.">
          Popover on top
        </button>
          <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Sometimes you want to add a popover to a hyperlink that wraps multiple lines. The default behavior of the popover plugin is to center it.">
          Popover on bottom
        </button>
          <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="right" data-content="Sometimes you want to add a popover to a hyperlink that wraps multiple lines. The default behavior of the popover plugin is to center it.">
          Popover on right
        </button>
        </div>
      </div>
      ...
      <div class="row m-t-70">
        <div class="col-lg-6">
          <h5>Tooltips</h5>
          <p>Tooltips are an updated version, which don’t rely on images, use CSS3 for animations, and data-attributes for local title storage.</p>
        ...
        <div class="col-lg-6">
          <h5>Live demo</h5>
          <p>For performance reasons, the Tooltip and Popover data-apis are opt-in, meaning you must initialize them yourself.</p>
