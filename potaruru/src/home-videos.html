      ...
      <div class="row row-5">
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="card card-video">
            <div class="card-img">
              <a href="video-post.html">
              <img src="https://i1.ytimg.com/vi/9xMsBIlvTEE/mqdefault.jpg" class="card-img-top" alt="Star Wars: Battlefront 2 New Gameplay">
            </a>
              <div class="card-meta">
                <span>4:32</span>
              </div>
            ...
            <div class="card-block">
              <h4 class="card-title"><a href="video-post.html">Star Wars: Battlefront 2 New Gameplay</a></h4>
              <div class="card-meta">
                <span><i class="fa fa-clock-o"></i> 3 days ago</span>
                <span>423 views</span>
              </div>
              <p>Multiplayer gameplay revealed for Star Wars Battlefront 2.</p>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="card card-video">
            <div class="card-img">
              <a href="video-post.html">
              <img src="https://i1.ytimg.com/vi/KsHHiWqgbw8/mqdefault.jpg" class="card-img-top" alt="I’m Ready To Spend Another 100 Hours">
            </a>
              <div class="card-meta">
                <span>4:59</span>
              </div>
            ...
            <div class="card-block">
              <h4 class="card-title"><a href="video-post.html">I’m Ready To Spend Another 100 Hours</a></h4>
              <div class="card-meta">
                <span><i class="fa fa-clock-o"></i> February 13, 2017</span>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="card card-video">
            <div class="card-img">
              <a href="video-post.html">
              <img src="https://i1.ytimg.com/vi/qZmnPUNP2Ps/mqdefault.jpg" class="card-img-top" alt="A Minute of Crazy Cosplay from Blizzcon">
            </a>
              <div class="card-meta">
                <span>1:15</span>
              </div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="card card-video">
            <div class="card-img">
              <a href="video-post.html">
              <img src="https://i1.ytimg.com/vi/WfBhaP6sIX0/mqdefault.jpg" class="card-img-top" alt="Hearthstone Mean Streets of Gadgetzan">
            </a>
              <div class="card-meta">
                <span>1:31</span>
              </div>
            ...
            <div class="card-block">
              <h4 class="card-title"><a href="video-post.html">Hearthstone Mean Streets of Gadgetzan</a></h4>
              <div class="card-meta">
                <span><i class="fa fa-clock-o"></i> February 5, 2017</span>
                <span>558 views</span>
              </div>
