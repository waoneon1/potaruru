...
<body class="fixed-header">
  ...
  <section class="toolbar toolbar-links" data-fixed="true">
    <div class="container">
      <h5 class="m-r-30">Recent Blogs (23)</h5>
      <form method="post" class="hidden-lg-down">
        <div class="form-group input-icon-right">
          <i class="fa fa-search"></i>
          <input type="text" class="form-control form-control-secondary" placeholder="Type to search...">
        </div>
      </form>
      <div class="dropdown float-right">
        <a class="btn btn-secondary btn-icon btn-sm m-l-25 float-right hidden-sm-down" href="#" data-toggle="dropdown" role="button"><i class="fa fa-cog"></i></a>
      ...
      <div class="dropdown float-right">
        <a class="btn btn-secondary btn-icon btn-sm m-l-25 float-right hidden-md-up" href="#" data-toggle="dropdown" role="button"><i class="fa fa-cog"></i></a>
      ...
      <ul class="toolbar-nav hidden-sm-down">
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="toolbar-custom">
            <a class="btn btn-default btn-icon btn-sm m-r-10 float-left hidden-xs-down" href="#" data-toggle="tooltip" title="refresh" data-placement="bottom" role="button"><i class="fa fa-refresh"></i></a>
            ...
            <a class="btn btn-default btn-icon btn-sm m-l-10 float-right hidden-xs-down" href="#" data-toggle="tooltip" title="list" data-placement="bottom" role="button"><i class="fa fa-bars"></i></a>
            <div class="dropdown float-right">
          ...
          <div class="post">
            ...
            <div class="post-thumbnail">
              <img src="img/blog/blog-1.jpg" alt="Uncharted The Lost Legacy First Gameplay Details Revealed">
            </div>
          ...
          <div class="post">
            <div class="post-header">
              ...
              <div>
                ...
                <div class="post-meta">
                  <span><i class="fa fa-clock-o"></i> May 30, 2017 by <a href="profile.html">Clark</a></span>
            ...
            <div class="post-thumbnail">
              <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="carousel-item active"><img src="img/blog/blog-2.jpg"></div>
                  <div class="carousel-item"><img src="img/blog/blog-3.jpg"></div>
                </div>
          ...
          <div class="post">
            <div class="post-header">
              ...
              <div>
                ...
                <div class="post-meta">
                  <span><i class="fa fa-clock-o"></i> May 22, 2017 by<a href="profile.html">Elizabeth</a></span>
          ...
          <div class="post">
            <div class="post-header">
              ...
              <div>
                ...
                <div class="post-meta">
                  <span><i class="fa fa-clock-o"></i> May 20, 2017 by<a href="profile.html">Trevor</a></span>
                  <span><a href="blog-post-disqus.html#comments"><i class="fa fa-comment-o"></i> 9 comments</a></span>
                </div>
              </div>
            </div>
            <div class="post-thumbnail">
              <img src="img/blog/blog-4.jpg" alt="The Witcher 3: Don't Miss This Hidden Contract in Blood and Wine">
            </div>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas elit ante, congue sodales orci ac, ultrices pretium lectus. Maecenas lorem enim, dignissim sed lacus non, feugiat iaculis lorem. Integer eu aliquet diam. Suspendisse fringilla
              porta justo, vel tempus risus. Ut et enim sit amet libero fermentum aliquam et ut sem.</p>
          </div>
