...
<body class="fixed-header">
  ...
  <section class="bg-primary">
    <div class="container">
      <h3 class="text-white font-weight-300 m-b-0">Alerts Component</h3>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <h5>Alerts</h5>
      <p class="m-b-25">Wrap any text and an optional dismiss button in <code>.alert</code> and one of the four contextual classes (e.g., <code>.alert-success</code>) for basic alert messages.</p>
      ...
      <div class="m-t-80">
        ...
        <p class="m-b-25">Using the alert JavaScript plugin, it’s possible to dismiss any alert inline. Add a dismiss button and the .alert-dismissible class, which adds extra padding to the right of the alert and positions the .close button.</p>
        ...
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
          ...
          <div class="p-a-15">
            ...
            <button type="button" class="btn btn-dark">Or do this</button>
          </div>
        </div>
      </div>
    </div>
