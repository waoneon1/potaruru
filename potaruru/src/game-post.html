...
<body class="fixed-header">
  ...
  <section class="toolbar toolbar-links" data-fixed="true">
    <div class="container">
      <h5>The Witcher 3: Wild Hunt <span>(34)</span></h5>
      ...
      <ul class="toolbar-nav m-r-25 hidden-md-down">
        <li class="active"><a href="game-post.html">Articles</a></li>
        ...
        <div class="col-lg-8">
          ...
          <div class="post">
            <div class="post-header">
              ...
              <div>
                <h2 class="post-title">
                  <a href="blog-post.html">The Witcher 3: Don't Miss This Hidden Contract in Blood and Wine</a>
                </h2>
                <div class="post-meta">
                  <span><i class="fa fa-clock-o"></i> Julye 28, 2017 by <a href="profile.html">Venom</a></span>
                  <span><a href="#">PS4</a>, <a href="#">Xbox One</a></span>
                  <span><a href="blog-post.html#comments"><i class="fa fa-comment-o"></i> 98 comments</a></span>
                </div>
              </div>
            </div>
            <div class="post-thumbnail">
              <img src="img/game/post-1.jpg" alt="The Witcher 3: Don't Miss This Hidden Contract in Blood and Wine">
              <span class="badge badge-danger">Blog</span>
            </div>
            <p><b>The Witcher 3: Wild Hunt</b>, officially announced in February 3, 2013, is an action-role playing video game developed by Polish studio, CD Projekt RED. It is the third title in The Witcher video game series, based on The Witcher saga,
              a collection of short stories by Polish author, Andrzej Sapkowski.</p>
            <p>Player have access to a in-game glossary. This allows players to read up on characters, bestiary, crafting and game mechanics. The bestiary tab gives detailed information about the beast in question, but also gives insight into their vulnerabilities.
              The tutorial tab allows for a deeper explanation on the game's mechanics. The character tab will give a condensed biography on the games characters.</p>
          </div>
          ...
          <div class="post">
            <div class="post-header">
              ...
              <div>
                <h2 class="post-title">
                  <a href="blog-post-carousel.html">The Witcher 3: Game of the Year Edition Release Date Announced</a>
                </h2>
                <div class="post-meta">
                  <span><i class="fa fa-clock-o"></i> June 19, 2017 by <a href="profile.html">Elizabeth</a></span>
                  <span><a href="#">Xbox One</a></span>
            ...
            <div class="post-thumbnail">
              <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="carousel-item active"><img src="https://img.youtube.com/vi/kZb9gnrnxS0/maxresdefault.jpg"></div>
                  <div class="carousel-item"><img src="https://img.youtube.com/vi/dPCPRtEf5IU/maxresdefault.jpg"></div>
                </div>
              ...
              <span class="badge badge-success">Carousel</span>
            </div>
            <p>The game plays much like the previous installment, <b>The Witcher 3</b>, with minor refinements made. The game will track both player choice and actions which ultimately affect how the game will end. The developers say that these choices can
              either be very tiny or absolutely major. </p>
          </div>
          ...
          <div class="post">
            <div class="post-header">
              ...
              <div>
                <h2 class="post-title">
                  <a href="blog-post-video.html">The Witcher 3: Wild Hunt 35 Minutes of Gameplay</a>
                </h2>
                <div class="post-meta">
                  <span><i class="fa fa-clock-o"></i> June 16, 2017 by <a href="profile.html">Trevor</a></span>
                  <span><a href="#">PS4</a></span>
                  <span><a href="blog-post-video.html#comments"><i class="fa fa-comment-o"></i> 33 comments</a></span>
                </div>
              </div>
            </div>
            <div class="post-thumbnail">
              <div class="video-play" data-src="https://www.youtube.com/embed/N4ony2r0QFs?rel=0&amp;amp;autoplay=1&amp;amp;showinfo=0">
                <div class="embed-responsive embed-responsive-16by9">
                  <img class="embed-responsive-item" src="https://img.youtube.com/vi/-FAfCbkpicw/maxresdefault.jpg">
          ...
          <div class="post">
            <div class="post-header">
              ...
              <div>
                <h2 class="post-title">
                  <a href="review-post.html">The Witcher 3: Wild Hunt Blood and Wine Review</a>
                </h2>
                <div class="post-meta">
                  <span><i class="fa fa-clock-o"></i> June 05, 2017 by <a href="profile.html">Clark</a></span>
                  <span><a href="#"><i class="fa fa-steam"></i>  Steam</a></span>
                  <span><a href="review-post#comments"><i class="fa fa-comment-o"></i> 29 comments</a></span>
                </div>
              </div>
            </div>
            <blockquote class="blockquote">
              <p>“This allows players to read up on characters, bestiary, crafting and game mechanics.”</p>
            </blockquote>
            <p>The tutorial tab allows for a deeper explanation on the game's mechanics. The character tab will give a condensed biography on the game's characters. The crafting tab gives player access to the required ingredients for an item, though only
              blacksmiths can forge weapons and only armorers can craft armor.</p>
          </div>
        ...
        <div class="col-lg-4">
          ...
          <div class="sidebar">
            ...
            <div class="widget widget-game">
              <div class="widget-block" style="background-image: url('https://img.youtube.com/vi/U75Qkzc2tqA/maxresdefault.jpg')">
                ...
                <div class="widget-item">
                  ...
                  <button type="submit" class="btn btn-outline-default btn-block">Follow Now <i class="fa fa-heart-o"></i></button>
                </div>
              </div>
            </div>
            ...
            <div class="widget widget-post">
              ...
              <img src="https://i1.ytimg.com/vi/2fgU8cYrANs/mqdefault.jpg" alt="">
            </a>
              <h4>
                <a href="blog-post.html">The Witcher Book Author Doesn't Profit From the Games</a>
              </h4>
              <span><i class="fa fa-clock-o"></i> November 16, 2017</span>
              ...
              <ul class="widget-list">
                <li>
                  ...
                  <div>
                    <h4>
                      <a href="blog-post.html">Dead Island 2 and Escape Impressions</a>
                    </h4>
                ...
                <li>
                  ...
                  <div>
                    <h4>
                      <a href="blog-post.html">How to Finish Mafia 3 With All of Your Underbosses</a>
                    </h4>
                ...
                <li>
                  ...
                  <div>
                    <h4>
                      <a href="blog-post.html">Spider-Man Spin-Off, Venom, Gets Release Date</a>
                    </h4>
                    <span>June 10, 2017</span>
                  </div>
                </li>
                <li>
                  <div class="widget-img">
                    <a href="blog-post.html">
                    <img src="img/blog/blog-widget-4.jpg" alt="">
                  </a>
                  </div>
                  <div>
                    <h4>
                      <a href="blog-post.html">Is Ghost Recon: Wildlands Worth Your Time?</a>
                    </h4>
                    <span>June 16, 2017</span>
                  </div>
                </li>
            ...
            <div class="widget widget-gallery">
              ...
              <ul>
                <li>
                  <a href="img/gallery/gallery-lightbox-1.jpg" data-lightbox='{"disqus": true, "gallery": "witcher"}'>
                  <img src="https://i1.ytimg.com/vi/uRCS8JLPLfs/mqdefault.jpg" alt="">
                </a>
                </li>
                <li>
                  <a href="https://i1.ytimg.com/vi/dPCPRtEf5IU/maxresdefault.jpg" data-lightbox='{"disqus": true, "gallery": "witcher"}'>
                  <img src="https://i1.ytimg.com/vi/dPCPRtEf5IU/mqdefault.jpg" alt="">
                </a>
                </li>
                <li>
                  <a href="https://i1.ytimg.com/vi/kZb9gnrnxS0/maxresdefault.jpg" data-lightbox='{"disqus": true, "gallery": "witcher"}'>
                  <img src="https://i1.ytimg.com/vi/kZb9gnrnxS0/mqdefault.jpg" alt="">
                </a>
                </li>
              </ul>
              <a class="btn btn-primary btn-block m-t-15" href="gallery.html" role="button">Open Gallery</a>
            </div>
          </div>
        </div>
      </div>
