  ...
  <section class="p-t-40">
    <div class="container">
      <div class="forum-headline forum-panel">
        ...
        <a class="btn btn-primary btn-shadow float-right" href="forum-create.html" role="button">New topic <i class="fa fa-plus"></i></a>
      </div>
      <div class="forum">
        ...
        <div class="forum-group">
          <div class="forum-row">
            ...
            <div class="forum-title">
              <h4><a href="forum-post.html">Can't remember the title of a game</a></h4>
