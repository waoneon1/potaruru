...
<body class="fixed-header">
  ...
  <section class="bg-primary">
    <div class="container">
      <h3 class="text-white font-weight-300 m-b-0">Notifications</h3>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <h5>Example</h5>
          <p>Send a message to your visitors about action by adding notification.</p>
          <button type="button" class="btn btn-primary" data-toggle="notification" data-title="Default notification alert!">Notify me!</button>
        </div>
        <div class="col-lg-6">
          <h5>Variations</h5>
          <p>It is also possible to use different types of notification just like alert, danger etc.</p>
      ...
      <h5 class="m-t-50">Positions</h5>
      <p>Add custom placement to your notification. Use <code>data-alignment="*"</code> attribute to give a position.</p>
  ...
  <!-- plugins js -->
  <script src="plugins/notification/notification.js" charset="utf-8"></script>
  <script>
    (function($) {
      "use strict";
      // notification
