...
<body class="fixed-header">
  ...
  <section class="bg-primary promo promo-subscribe">
    <div class="container">
      ...
      <a class="btn btn-outline-default" href="https://themeforest.net/item/gameforest-responsive-gaming-html-theme/5007730" target="_blank" role="button">Subscribe <i class="fa fa-heart-o"></i></a>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      ...
      <div id="accordion" class="accordion accordion-icon" role="tablist">
        <div class="card">
        ...
        <div class="card">
          <div class="card-header" role="tab" id="headingThree">
            <h5>
              ...
              Can I upgrade my account from Basic to Unlimited?
            </a>
            </h5>
          </div>
          ...
          <div class="card-header" role="tab" id="headingFour">
            <h5>
              <a class="collapsed" data-toggle="collapse" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
               Are you planning to add new components?
            </a>
            </h5>
          </div>
        ...
        <div class="card">
          <div class="card-header" role="tab" id="headingFive">
            <h5>
              ...
              Gameforest is available for Wordpress?
            </a>
            </h5>
          </div>
      ...
      <div class="text-center"><a href="faq.html" class="btn btn-primary btn-shadow btn-rounded btn-effect btn-lg m-t-30">Learn More</a></div>
    </div>
  </section>
  ...
  <section class="bg-secondary p-y-40">
    <div class="container">
      <div class="owl-carousel owl-logos">
        <a href="#"><img src="img/sponsors/sponsor-1.png" alt=""></a>
        <a href="#"><img src="img/sponsors/sponsor-2.png" alt=""></a>
        <a href="#"><img src="img/sponsors/sponsor-3.png" alt=""></a>
        <a href="#"><img src="img/sponsors/sponsor-4.png" alt=""></a>
        <a href="#"><img src="img/sponsors/sponsor-5.png" alt=""></a>
      </div>
    </div>
  </section>
  <!-- /main -->
