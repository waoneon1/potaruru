...
<body class="fixed-header">
  ...
  <section class="bg-primary">
    <div class="container">
      <h3 class="text-white font-weight-300 m-b-0">Tabs Component</h3>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <h5>Example</h5>
      <p class="m-b-30">Add quick, dynamic tab functionality to transition through panes of local content, even via dropdown menus.</p>
      ...
      <div class="tab-content p-t-30">
        <div class="tab-pane active" id="ps4" role="tabpanel">
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer malesuada lacinia lobortis. Proin sodales ligula augue, at mattis ipsum accumsan at. Proin aliquam fermentum pretium. Etiam euismod velit tempus orci porttitor, vel efficitur libero
            gravida. Donec pretium convallis suscipit.</p>
        </div>
      ...
      <h5 class="m-t-80">Icons</h5>
      <p class="m-b-30">You can activate a tab or pill navigation without writing any JavaScript by simply specifying data-toggle="tab" or data-toggle="pill" on an element.</p>
      ...
      <div class="tab-content p-t-30">
        ...
        <div class="tab-pane" id="settings" role="tabpanel">
          <p>Mauris ultrices semper sapien, nec mollis orci aliquam a. Praesent nec urna quis enim venenatis faucibus. Aliquam hendrerit commodo diam, eu bibendum magna sodales et. In vestibulum ornare dapibus. Ut posuere urna eget turpis eleifend, a facilisis
            justo aliquet.</p>
        </div>
      ...
      <h5 class="m-t-80">Boxed Tabs</h5>
      <p class="m-b-30">Add <code>.tabs-boxed</code> div to make tab compatible with boxed style.</p>
      <div class="tabs-boxed">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="boxed-profile" role="tabpanel">
            <p class="m-b-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer malesuada lacinia lobortis. Proin sodales ligula augue, at mattis ipsum accumsan at. Proin aliquam fermentum pretium. Etiam euismod velit tempus orci porttitor, vel efficitur
              libero gravida. Donec pretium convallis suscipit. Aliquam vel ullamcorper purus, quis lobortis urna. Nam faucibus facilisis diam. Nullam elementum libero at eleifend accumsan.</p>
          </div>
          <div class="tab-pane" id="boxed-settings" role="tabpanel">
            <p class="m-b-0">Mauris ultrices semper sapien, nec mollis orci aliquam a. Praesent nec urna quis enim venenatis faucibus. Aliquam hendrerit commodo diam, eu bibendum magna sodales et. In vestibulum ornare dapibus. Ut posuere urna eget turpis eleifend, a facilisis
              justo aliquet.</p>
          </div>
          <div class="tab-pane" id="boxed-inbox" role="tabpanel">
            <p class="m-b-0">Quisque et tincidunt dolor. Praesent nec lacinia dolor. Pellentesque ligula ante, dignissim a suscipit in, rutrum ac nulla. Fusce sagittis dolor massa, in pellentesque erat ultricies vitae.</p>
          </div>
          <div class="tab-pane" id="boxed-games" role="tabpanel">
            <p class="m-b-0">Suspendisse massa nisi, maximus eu ligula posuere, blandit scelerisque neque. Praesent consequat leo malesuada, eleifend augue nec, porta quam.</p>
          </div>
        </div>
      </div>

      <h5 class="m-t-70">Colorized Tabs</h5>
      <p class="m-b-30">Use <code>.tabs-color</code> class with the tab component and it will be looks like in the example below.</p>
