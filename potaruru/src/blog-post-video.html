...
<body class="fixed-header">
  ...
  <section class="breadcrumbs">
    <div class="container">
      <ol class="breadcrumb">
        ...
        <li class="active">Dead Island 2 Official E3 Announce Gameplay Trailer</li>
      </ol>
    </div>
  </section>
      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          ...
          <div class="post post-single">
            <h2 class="post-title">Dead Island 2 Official E3 Announce Gameplay Trailer</h2>
            <div class="post-meta">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas elit ante, congue sodales orci ac, ultrices pretium lectus. Maecenas lorem enim, dignissim sed lacus non, feugiat iaculis lorem. Integer eu aliquet diam. Suspendisse fringilla
              porta justo, vel tempus risus. Ut et enim sit amet libero fermentum aliquam et ut sem. Donec sit amet eros nulla. Proin non fermentum odio. Pellentesque ut sodales erat, ac aliquam sem. Praesent tempus velit ac leo hendrerit auctor. Cras
              id efficitur eros.</p>
            ...
            <h5>Absolute the best game we have ever seen</h5>
  ...
  <section class="pager">
    <div style="background-image: url('img/blog/blog-pager-1.jpg')">
      <div class="overlay"></div>
      <h2><a href="blog-post-carousel.html">The Last of Us 2 Was Teased in September and Nobody Noticed</a></h2>
    </div>
    <div style="background-image: url('img/blog/blog-pager-2.jpg')">
      <div class="overlay"></div>
      <h2><a href="blog-post-video.html">Witcher 3: Don't Miss This Hidden Contract in Blood and Wine</a></h2>
    </div>
  </section>
  <!-- /main -->
