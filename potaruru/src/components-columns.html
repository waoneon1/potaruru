...
<body class="fixed-header">
  ...
  <section class="bg-primary">
    <div class="container">
      <h3 class="text-white font-weight-300 m-b-0">Columns</h3>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h5>12 Columns</h5>
          <p>Cras consequat porttitor tincidunt. Praesent eu tincidunt lacus. Donec ut neque vitae erat congue venenatis. Duis hendrerit lacinia leo in dignissim. Aliquam erat volutpat. Sed dignissim hendrerit nibh, quis faucibus erat cursus eget. Integer
            porta nisl vitae felis rutrum ut mollis felis congue. Vestibulum augue nisl, egestas eu rhoncus eu, fermentum in leo. Pellentesque ultricies pharetra nulla sit amet sagittis. Curabitur at feugiat nibh. Duis sit amet odio eros. Donec non purus
            non augue cursus convallis sed id purus.</p>
        </div>
      </div>
      <br>
      <div class="row">
        <div class="col-lg-8">
          <h5>8 Columns</h5>
          <p>Integer vulputate tempus luctus. Etiam nisi sem, pretium eget libero eget, interdum aliquam metus. Curabitur scelerisque nisi eu ultricies pretium. Donec at augue porta, hendrerit eros a, vehicula lacus. Suspendisse tempor ex ipsum, eu mattis
            lorem suscipit sed. Donec commodo non est et tincidunt.</p>
        </div>
        <div class="col-lg-4">
          <h5>4 Columns</h5>
