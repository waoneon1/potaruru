...
<body class="fixed-header">
  ...
  <section class="bg-primary">
    <div class="container">
      <h3 class="text-white font-weight-300 m-b-0">Charts</h3>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <h5>Line Chart</h5>
      <p>Morris.js is the library that powers the graphs on. It's a very simple API for drawing line, bar, area and donut charts.</p>
      <div id="morris-line-chart"></div>

      <h5 class="m-t-70">Bar Chart</h5>
      ...
      <div class="row m-t-70">
        ...
        <div class="col-lg-6">
          <h5>Donut Chart</h5>
          <p>This really couldn't be easier. Create a Donut chart using Morris.Donut(options), with the following options.</p>
