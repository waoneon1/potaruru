...
<body class="fixed-header">
  ...
  <section class="bg-primary">
    <div class="container">
      <h3 class="text-white font-weight-300 m-b-0">Form Layouts</h3>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <h5>Login Form</h5>
      <p>Use login form to handle user authentication. Add your custom component like social button, checkbox or inputs.</p>
      <div class="row m-t-30">
        ...
        <div class="col-lg-4">
          <form action="profile.html">
            ...
            <a class="btn btn-default btn-block" href="register.html" role="button">Register</a>
          </form>
        </div>
      </div>
      ...
      <div class="row m-t-30">
        <div class="col-lg-4">
          ...
          <p class="m-b-30">Easy to create and use registration forms.</p>
          <div class="card">
            <div class="card-header">
        ...
        <div class="col-lg-8">
          ...
          <p class="m-b-30">Add your custom component like social button, checkbox or inputs.</p>
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-header">
                ...
                <div class="card-block">
                  <form>
                    ...
                    <button type="submit" class="btn btn-primary btn-block m-t-10">Reset Password</button>
                  </form>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              ...
              <form class="m-t-15">
                ...
                <button type="submit" class="btn btn-primary btn-shadow btn-block m-t-10">Reset Password</button>
              </form>
            </div>
          </div>
        </div>
      ...
      <h5 class="m-t-40">Contact Form</h5>
      <p>Use login form to handle user authentication. Add your custom component like social button, checkbox or inputs.</p>
      <div class="row m-t-30">
        <div class="col-lg-6">
          <form method="post">
