...
<body class="fixed-header">
  ...
  <section class="bg-primary">
    <div class="container">
      <h3 class="text-white font-weight-300 m-b-0">FontAwesome Icons</h5>
    </div>
  </section>
    ...
    <div class="container">
      <form method="post">
        <div class="form-group input-icon-right">
          ...
          <input type="text" class="form-control" id="icon-search" placeholder="Search Icon...">
        </div>
      </form>

      <div class="icons">
        <h5>41 New Icons in 4.7</h5>
